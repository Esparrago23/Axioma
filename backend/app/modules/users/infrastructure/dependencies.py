...
from app.modules.users.infrastructure.controllers.update_fcm_token_controller import UpdateFcmTokenController
...
def update_fcm_token_uc(repo=Depends(get_user_repo)): return UpdateFcmTokenUseCase(repo)
...
def update_fcm_token_controller(uc=Depends(update_fcm_token_uc)): return UpdateFcmTokenController(uc)
